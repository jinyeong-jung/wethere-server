...
export interface Query {
  ...
  GetFeeds: GetFeedsResponse;
  GetPlaceFeeds: GetPlaceFeedsResponse;
  GetPlaces: GetPlacesResponse;
...
export interface FeedDetailQueryArgs {
  feedId: number;
}

export interface GetPlaceFeedsQueryArgs {
  placeId: number;
}

export interface PlaceDetailQueryArgs {
  placeId: number;
}
...
export interface GetPlacesResponse {
  ok: boolean;
  error: string | null;
  visitedPlaces: Array<Place> | null;
  notVisitedPlaces: Array<Place> | null;
}
